...
#######################################################
sql_cmd_issue_stackframe='''select issue_id,count(distinct event_id) as crash_count,count(distinct installation_uuid) as total_user from `firebase_crashlytics_com_booking_ANDROID` where event_timestamp >= '2021-08-20 03:45:21' and event_timestamp <= '2021-08-29 03:45:21'and issue_id='5c06a163f8b88c296382cb87';'''
